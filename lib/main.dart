...
class _MapsState extends State<Maps> { 
  ...
  final _initialPosition = const CameraPosition( 
    ...
    target: LatLng(-20.275254117182865, -50.541017507937056), 
  ...
  Widget build(BuildContext context) { 
    ...
    return Scaffold( 
      ...
      appBar: AppBar(title: const Text('Exemplo de Mapas')), 
      ...
      body: GoogleMap( 
        ...
        markers: { 
          ...
          const Marker( 
            ...
            position: LatLng(-20.275254117182865, -50.541017507937056), 
            ...
            infoWindow: InfoWindow( 
              ...
              snippet: 'Clique no marker para ter a localização original', 
